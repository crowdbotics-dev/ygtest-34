"""
Django settings for ygtest_34 project.
...
WSGI_APPLICATION = "ygtest_34.wsgi.application"
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Ygtest Support <support@ygtest-34.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ygtest_34 API",
    "DESCRIPTION": "API documentation for ygtest_34 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "ygtest_34.storage_backends.AzureMediaStorage"
