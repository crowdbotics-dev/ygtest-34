...
class GbcconenctorViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_GBC_CONENCTOR_PASSWORD
    USERNAME = settings.CONNECTOR_GBC_CONENCTOR_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_GBC_CONENCTOR"
